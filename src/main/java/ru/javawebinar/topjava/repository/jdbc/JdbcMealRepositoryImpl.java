...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        ...
        if (meal.isNew()) {
            ...
            meal.setId(key.intValue());
                ...
                "UPDATE meals SET date_time = :date_time, calories = :calories, description = :description WHERE id = :id " +
    ...
    public Meal get(int id, int userId) {
        List<Meal> resultList = jdbcTemplate.query(
    ...
    public List<Meal> getBetween(LocalDateTime startDate, LocalDateTime endDate, int userId) {
        return jdbcTemplate.query(
                "SELECT * FROM meals WHERE user_id = ? AND DATE(date_time) >= ? AND DATE(date_time) <= ?" +
